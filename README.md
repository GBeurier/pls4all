...
**Status — Phase 1 shipped, Phase 3h preprocessing pipeline live, PLSCanonical, PLSSVD, PLS-DA, OPLS / OPLS-DA, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD, power, randomized-SVD and PCR core live · API unstable until v1.0 · Not yet on PyPI / CRAN / npm.**
...
| 3 — NIRS preprocessing & validation | in progress | pipeline fit/transform · identity · center · autoscale · Pareto · SNV · MSC · EMSC · detrend · SG · ASLS · Norris-Williams · Haar wavelet denoise |
...
`P4A_OP_ASLS_BASELINE` and `P4A_OP_WAVELET_DENOISE`, with explicit
