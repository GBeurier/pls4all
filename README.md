...
The current local report covers 64 methods and 104 reference rows. Status
breakdown:
...
40 of 64 methods (62 %) have at least one passing external reference.
Pass-quality breakdown (across the 41 `ok` rows):
