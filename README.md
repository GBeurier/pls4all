...
**Status — Phase 1 shipped, Phase 3r preprocessing / validation core live, PLSCanonical, PLSSVD, PLS-DA, PLS-LDA, PLS-logistic, MB-PLS, LW-PLS, OPLS / OPLS-DA, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD, power, randomized-SVD, PCR and Phase 5b variable-selection / interval-selection core live · API unstable until v1.0 · Not yet on PyPI / CRAN / npm.**
...
| 5 — Variable selection | in progress | VIP/coefficient/selectivity-ratio rankers shipped · interval/moving-window CV scan shipped · iPLS · MCUVE · CARS · SPA · Random Frog · GA-PLS |
...
selection. Coefficient kernels materialise the original-scale
