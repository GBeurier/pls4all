...
**Status — Phase 1 shipped, SIMPLS and SVD core live · API unstable until v1.0 · Not yet on PyPI / CRAN / npm.**
...
The core currently implements NIPALS, SIMPLS and SVD PLS regression behind the
stable C ABI: `p4a_model_fit`, `predict`, `transform`, fitted-array accessors
and binary import/export are live for `P4A_ALGO_PLS_REGRESSION` with
