...
**Status — Phase 1 shipped, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD and PCR core live · API unstable until v1.0 · Not yet on PyPI / CRAN / npm.**
...
The core currently implements NIPALS, orthogonal-scores, SIMPLS, kernel, wide-kernel and SVD PLS regression plus PCR
