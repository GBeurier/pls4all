...
The current local report covers 64 methods and 103 reference rows. Status
breakdown: 38 `ok`, 2 `parity_failed`, 25 `paper_only`, 29
`no_python_reference`, and 9 `no_r_reference`. Runtime / speed-up
benchmarks are tracked separately by
[`benchmarks/runners/matrix.py`](benchmarks/runners/matrix.py).
...
| `parity_failed` | 2 |
| `paper_only` | 25 |
| `no_python_reference` | 29 |
| `no_r_reference` | 9 |

The parity-gate audit currently tracks these numerical divergence entries:

| Method | RMSE rel | Tolerance | Status | Classification |
|--------|----------|-----------|--------|----------------|
| `variable_select_vip` | 6.324555e-01 | 7.000e-01 | `ok` | Reference fishy |
| `variable_select_coef` | 1.000000e+00 | 1.100e+00 | `ok` | Reference fishy |
| `variable_select_sr` | 1.183216e+00 | 1.300e+00 | `ok` | Reference fishy |
| `t2_select` | 1.154701e+00 | 1.200e+00 | `ok` | Reference fishy |
| `rep_select` | 1.699673e+00 | 1.800e+00 | `ok` | Reference fishy |
| `interval_select` | 9.128709e-01 | 1.000e+00 | `ok` | Algorithmic divergence |
| `spa_select` | 1.057188e+00 | 1.200e+00 | `ok` | Algorithmic divergence |
| `cars_select` | 1.290994e+00 | 1.400e+00 | `ok` | Algorithmic divergence |
| `bve_select` | 1.290994e+00 | 1.400e+00 | `ok` | Algorithmic divergence |
| `ipw_select` | 8.819171e-01 | 1.000e+00 | `ok` | Algorithmic divergence |
| `st_select` | 2.000000e+00 | 2.100e+00 | `ok` | Algorithmic divergence |
| `stability_select` | 1.264911e+00 | 7.000e-01 | `parity_failed` | Stochastic divergence |
| `ga_select` | 1.195229e+00 | 1.000e+00 | `parity_failed` | Stochastic divergence |
