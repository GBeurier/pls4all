...
| 5 — Variable selection | in progress | VIP/coefficient/selectivity-ratio rankers shipped · interval/moving-window CV scan shipped · coefficient-stability selector shipped · iPLS · MCUVE · CARS · SPA · Random Frog · GA-PLS |
...
coefficient mean/std ratios for MCUVE-style ranking. Coefficient kernels materialise the original-scale
