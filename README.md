...
**Status — Phase 1 shipped, Phase 3r preprocessing / validation core live, PLSCanonical, PLSSVD, PLS-DA, PLS-LDA, PLS-logistic, MB-PLS, LW-PLS, OPLS / OPLS-DA, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD, power, randomized-SVD, PCR and Phase 5a variable-selection rankers core live · API unstable until v1.0 · Not yet on PyPI / CRAN / npm.**
...
| 5 — Variable selection | in progress | VIP/coefficient/selectivity-ratio rankers shipped · iPLS · MCUVE · CARS · SPA · Random Frog · GA-PLS |
...
selectivity-ratio scores. Coefficient kernels materialise the original-scale
