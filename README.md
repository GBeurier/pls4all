...
**Status — Phase 1 shipped, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD, power and PCR core live · API unstable until v1.0 · Not yet on PyPI / CRAN / npm.**
...
The core currently implements NIPALS, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD and power-iteration PLS regression plus PCR
...
`P4A_SOLVER_POWER`, and for `P4A_ALGO_PCR` with
`P4A_SOLVER_SVD`.
