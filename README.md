...
| 5 — Variable selection | in progress | VIP/coefficient/selectivity-ratio rankers shipped · interval/moving-window CV scan shipped · coefficient-stability selector shipped · UVE artificial-variable selector shipped · iPLS · MCUVE · CARS · SPA · Random Frog · GA-PLS |
...
threshold real-variable stability against deterministic artificial variables. Coefficient kernels materialise the original-scale
