...
**Status — Phase 1 shipped, Phase 3a preprocessing pipeline live, PLSCanonical, PLSSVD, PLS-DA, OPLS / OPLS-DA, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD, power, randomized-SVD and PCR core live · API unstable until v1.0 · Not yet on PyPI / CRAN / npm.**
...
`P4A_OP_AUTOSCALE`, `P4A_OP_PARETO_SCALE` and `P4A_OP_SNV`, with explicit
