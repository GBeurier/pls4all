...
|--------|------------------|-------------|--------------------|--------|
| `sparse_simpls` | — | `spls` 2.3.2 | — / 2.51e-05 | R PASS |
| `di_pls` | paper-only | paper-only | — / — | paper-only (Nikzad-Langerodi 2018) |
| `recursive_pls` | `scikit-learn` 1.4.2 | `pls` 2.8.5 | 1.23e-02 / 1.23e-02 | both PASS |
| `cppls` | paper-only | paper-only | — / — | paper-only (Indahl 2005) |
| `weighted_pls` | `scikit-learn` 1.4.2 | — | 9.28e-07 / — | Py PASS |
| `robust_pls` | paper-only | paper-only | — / — | paper-only (Cummins 1995) |
| `ridge_pls` | `scikit-learn` 1.4.2 | — | 1.02e-07 / — | Py PASS |
| `continuum_regression` | paper-only | paper-only | — / — | paper-only (Stone & Brooks 1990) |
| `n_pls` | paper-only | paper-only | — / — | paper-only (Bro 1996) |
| `kernel_pls_rbf` | paper-only | paper-only | — / — | paper-only (Rosipal & Trejo 2001) |
| `o2pls` | — | `OmicsPLS` 2.1.0 | — / 4.54e-01 | R qualitative (joint-iter variant) |
| `approximate_press` | paper-only | paper-only | — / — | paper-only (Eastment & Krzanowski 1982) |
