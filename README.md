...
**Status — Phase 1 shipped, PLSCanonical, PLS-DA, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD, power, randomized-SVD and PCR core live · API unstable until v1.0 · Not yet on PyPI / CRAN / npm.**
...
The core currently implements NIPALS, orthogonal-scores, SIMPLS, kernel, wide-kernel, SVD, power-iteration and randomized-SVD PLS regression, PLSCanonical, PLS-DA and PCR
...
`P4A_DEFLATION_REGRESSION`, and for `P4A_ALGO_PCR` with `P4A_SOLVER_SVD`.
