...
AUG_SPECS: list[DonorOpSpec] = [
    ...
    _aug("aug_truncated_peak", "aug_truncated_peak", "TruncatedPeakAugmenter", wl=True, dump=False),
    _aug("aug_edge_artifacts", "aug_edge_artifacts", "EdgeArtifactsAugmenter", wl=True, dump=False),
    _aug("aug_spline_smooth", "aug_spline_smooth", "SplineSmoothingAugmenter", dump=False),
    _aug("aug_spline_x_perturb", "aug_spline_x_perturb", "SplineXPerturbationAugmenter", dump=False),
