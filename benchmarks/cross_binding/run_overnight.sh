...

{
  ...
  echo "# references=${REFERENCE_BACKENDS} canonical_only=${CANONICAL_ONLY} resume=${RESUME} force=${FORCE} rerun_failed=${RERUN_FAILED} render_docs=${RENDER_DOCS} timeout=${TIMEOUT}"
