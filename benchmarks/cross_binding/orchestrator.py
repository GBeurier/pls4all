...
def r_base(expr: str, *, compare: bool = True, contract_note: str = "") -> ReferenceSpec:
    return ReferenceSpec("ref.r.base", "R base", compare=compare, language="R", r_expr=expr, contract_note=contract_note)


def r_stats(expr: str, *, compare: bool = True, contract_note: str = "") -> ReferenceSpec:
...
def benchmark_spec(
    ...
    *,
    ...
    canonical_ref = next((ref for ref in spec.references if ref.compare), None) if include_external else None
