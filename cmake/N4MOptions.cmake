...
set(N4M_WITH_FITPACK "AUTO" CACHE STRING
    "Build the vendored FITPACK spline smoother when a compatible Fortran compiler is available (AUTO, ON, OFF)")
set_property(CACHE N4M_WITH_FITPACK PROPERTY STRINGS AUTO ON OFF)
...
if(NOT N4M_WITH_FITPACK STREQUAL "AUTO"
        AND NOT N4M_WITH_FITPACK STREQUAL "ON"
        AND NOT N4M_WITH_FITPACK STREQUAL "OFF")
    message(FATAL_ERROR
        "N4M_WITH_FITPACK must be AUTO, ON, or OFF "
        "(got '${N4M_WITH_FITPACK}').")
endif()
