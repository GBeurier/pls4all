...
def _generate_all() -> dict[str, bytes]:
    ...
    return {
        ...
        "synthetic_aom_soft_preprocessing_v1": _serialize(suites.synthetic_aom_soft_preprocessing_v1()),
        "synthetic_aom_hard_preprocessing_v1": _serialize(suites.synthetic_aom_hard_preprocessing_v1()),
        "synthetic_aom_strict_operators_v1": _serialize(suites.synthetic_aom_strict_operators_v1()),
        "synthetic_aom_extended_strict_operators_v1": _serialize(suites.synthetic_aom_extended_strict_operators_v1()),
        ...
        "synthetic_bipls_backward_intervals_v1": _serialize(suites.synthetic_bipls_backward_intervals_v1()),
        "synthetic_sipls_interval_combinations_v1": _serialize(suites.synthetic_sipls_interval_combinations_v1()),
        ...
        "synthetic_randomization_pls_permutation_v1": _serialize(suites.synthetic_randomization_pls_permutation_v1()),
