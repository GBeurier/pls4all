...
This is the canonical parity floor for the ``c4a_filter_x_outlier_*``
...
releases can change without breaking the chemometrics4all parity gate.
...
The chemometrics4all C engine produces near-bit-identical masks where the
