...
#
# Fixture loader for the chemometrics4all R binding parity tests.
#
...
# locate the fixture root via either the `CHEMOMETRICS4ALL_FIXTURE_DIR`
...
.c4a_locate_fixture_dir <- function() {
  ...
  stop("chemometrics4all tests: could not locate parity/fixtures/. ",
       "Set CHEMOMETRICS4ALL_FIXTURE_DIR.",
       call. = FALSE)
}
