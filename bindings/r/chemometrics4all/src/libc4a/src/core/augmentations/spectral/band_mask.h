 ...
 */
#ifndef CHEMOMETRICS4ALL_CORE_AUG_BAND_MASK_H
#define CHEMOMETRICS4ALL_CORE_AUG_BAND_MASK_H
...
typedef enum c4a_aug_band_mask_mode_t {
    C4A_AUG_BAND_MASK_ZERO   = 0,
    C4A_AUG_BAND_MASK_INTERP = 1
} c4a_aug_band_mask_mode_t;

typedef struct c4a_aug_band_mask_state_t c4a_aug_band_mask_state_t;
...
#endif /* CHEMOMETRICS4ALL_CORE_AUG_BAND_MASK_H */
