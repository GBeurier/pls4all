...
struct c4a_aug_rotate_translate_state_t {
    double p_range;
    double y_factor;
};
...
c4a_aug_rotate_translate_state_t* c4a_aug_rotate_translate_state_new(
    ...
    c4a_aug_rotate_translate_state_t* s =
        (c4a_aug_rotate_translate_state_t*)calloc(1, sizeof(*s));
...
c4a_status_t c4a_aug_rotate_translate_state_apply(
    ...
    if (xr == NULL) return C4A_ERR_OUT_OF_MEMORY;
    if (cols == 1) {
        xr[0] = 0.0;
    } else {
