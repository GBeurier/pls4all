...
/*
 * Internal C engine for the Gaussian operator. Public C ABI lives in c4a.h
 * (§10, Phase 4).
 *
 ...
 * the shared c4a_pad_resolve_index helper.
 *
 * Lifecycle: stateless.  Kernel is precomputed in `_create`.
 */
#ifndef CHEMOMETRICS4ALL_CORE_PP_SMOOTHING_GAUSSIAN_H
#define CHEMOMETRICS4ALL_CORE_PP_SMOOTHING_GAUSSIAN_H
...
typedef struct c4a_pp_gaussian_state_t c4a_pp_gaussian_state_t;
...
#endif /* CHEMOMETRICS4ALL_CORE_PP_SMOOTHING_GAUSSIAN_H */
