...
struct c4a_pp_wavelet_pca_state_t {
...
c4a_pp_wavelet_pca_state_t* c4a_pp_wavelet_pca_state_new(
    ...
    c4a_pp_wavelet_pca_state_t* s =
        (c4a_pp_wavelet_pca_state_t*)malloc(sizeof(*s));
...
static c4a_status_t dwt_flatten_row(const double* row, int64_t cols,
                                      c4a_wavelet_family_t family,
                                      c4a_wavelet_mode_t mode,
                                      int32_t level,
                                      int64_t total_flat,
                                      ...
                                      int64_t* offsets,
                                      double* flat_out) {
    return c4a_wavelet_wavedec(row, cols, family, mode, level,
