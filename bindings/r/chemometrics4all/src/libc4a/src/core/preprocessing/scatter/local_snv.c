...
c4a_pp_lsnv_state_t* c4a_pp_lsnv_state_new(int32_t window,
    ...
    c4a_pp_lsnv_state_t* s = (c4a_pp_lsnv_state_t*)malloc(sizeof(*s));
    if (s == NULL) {
        return NULL;
    }
    s->window         = window;
