 ...
 * `np.digitize(X, bins, right=False)`). The public C ABI lives in c4a.h
 ...
 */
#ifndef CHEMOMETRICS4ALL_CORE_PP_RESAMPLING_RANGE_DISCRETIZER_H
#define CHEMOMETRICS4ALL_CORE_PP_RESAMPLING_RANGE_DISCRETIZER_H
...
typedef struct c4a_pp_range_disc_state_t c4a_pp_range_disc_state_t;
...
c4a_pp_range_disc_state_t* c4a_pp_range_disc_state_new(const double* bins,
                                                        int64_t n_edges);

void c4a_pp_range_disc_state_free(c4a_pp_range_disc_state_t* state);
...
c4a_status_t c4a_pp_range_disc_apply(const c4a_pp_range_disc_state_t* state,
                                      const double* X,
...
#endif /* CHEMOMETRICS4ALL_CORE_PP_RESAMPLING_RANGE_DISCRETIZER_H */
