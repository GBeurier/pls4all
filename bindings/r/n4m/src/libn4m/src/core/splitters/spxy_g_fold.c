...
n4m_split_spxy_g_fold_state_t* n4m_split_spxy_g_fold_state_new(int32_t n_splits,
                                                                int32_t use_y,
                                                                int32_t aggregation) {
    if (n_splits < 2) return NULL;
    if (aggregation != 0 && aggregation != 1) return NULL;
    n4m_split_spxy_g_fold_state_t* s =
        (n4m_split_spxy_g_fold_state_t*)malloc(sizeof(*s));
...
void n4m_split_spxy_g_fold_state_free(n4m_split_spxy_g_fold_state_t* state) {
    free(state);
}
...
n4m_status_t n4m_split_spxy_g_fold_assign(const n4m_split_spxy_g_fold_state_t* s,
    ...
    n4m_split_spxy_fold_state_t inner;
    ...
    n4m_status_t st = n4m_split_spxy_fold_assign(&inner, X_rep, n_groups,
                                                  cols_x, Y_rep, cols_y,
                                                  group_folds);
    if (st != N4M_OK) {
        free(sample_to_group); free(unique_groups);
...
n4m_status_t n4m_split_spxy_g_fold_extract(const int32_t* fold_assignment,
                                            int64_t rows, int32_t fold_idx,
                                            n4m_split_result_t* out) {
    return n4m_split_spxy_fold_extract(fold_assignment, rows, fold_idx, out);
}
