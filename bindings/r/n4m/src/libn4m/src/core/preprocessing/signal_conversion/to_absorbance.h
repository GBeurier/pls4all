 ...
 * `epsilon` must be > 0.
 */
#ifndef N4M_CORE_PP_SIGNAL_CONVERSION_TO_ABSORBANCE_H
#define N4M_CORE_PP_SIGNAL_CONVERSION_TO_ABSORBANCE_H
...
typedef struct n4m_pp_to_absorbance_state_t n4m_pp_to_absorbance_state_t;
...
#endif /* N4M_CORE_PP_SIGNAL_CONVERSION_TO_ABSORBANCE_H */
