 ...
 */
#ifndef N4M_CORE_UTILITIES_HOTELLING_T2_H
#define N4M_CORE_UTILITIES_HOTELLING_T2_H
...
n4m_status_t n4m_util_hotelling_t2_impl(const double* X,
...
#endif /* N4M_CORE_UTILITIES_HOTELLING_T2_H */
