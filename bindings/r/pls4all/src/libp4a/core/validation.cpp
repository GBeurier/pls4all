...
[[nodiscard]] bool validate_sample_count(::n4m::core::Context& ctx,
...
[[nodiscard]] bool checked_fold_count(::n4m::core::Context& ctx,
                                      std::int32_t left,
...
[[nodiscard]] n4m_status_t validate_numeric_matrix(::n4m::core::Context& ctx,
...
[[nodiscard]] n4m_status_t compute_pairwise_squared_distances(
    ::n4m::core::Context& ctx,
    const n4m_matrix_view_t& matrix,
...
[[nodiscard]] n4m_status_t select_representative_indices(
    ::n4m::core::Context& ctx,
...
n4m_status_t make_kfold_validation_plan(Context& ctx,
                                        std::int64_t n_samples,
...
n4m_status_t make_leave_one_out_validation_plan(Context& ctx,
                                               std::int64_t n_samples,
                                               ValidationPlan& out) {
...
n4m_status_t make_holdout_validation_plan(Context& ctx,
                                         std::int64_t n_samples,
                                         std::int64_t test_start,
...
n4m_status_t make_external_folds_validation_plan(Context& ctx,
                                                std::int64_t n_samples,
...
n4m_status_t make_repeated_kfold_validation_plan(Context& ctx,
                                                std::int64_t n_samples,
                                                std::int32_t n_splits,
...
n4m_status_t make_monte_carlo_validation_plan(Context& ctx,
                                             std::int64_t n_samples,
                                             std::int64_t test_count,
                                             std::int32_t n_repeats,
                                             std::uint64_t seed,
...
n4m_status_t make_kennard_stone_validation_plan(Context& ctx,
                                               const n4m_matrix_view_t& X,
                                               std::int64_t train_count,
                                               ValidationPlan& out) {
    try {
        out = ValidationPlan{};
        const n4m_status_t status = validate_numeric_matrix(ctx, X, "X");
        if (status != N4M_OK) {
            return status;
        }

        std::vector<double> distances;
        n4m_status_t dist_status = compute_pairwise_squared_distances(ctx, X, distances);
        if (dist_status != N4M_OK) {
            return dist_status;
        }
        std::vector<std::int64_t> selected;
...
n4m_status_t make_spxy_validation_plan(Context& ctx,
                                      const n4m_matrix_view_t& X,
    ...
    try {
        out = ValidationPlan{};
        n4m_status_t status = validate_numeric_matrix(ctx, X, "X");
        if (status != N4M_OK) {
            return status;
        }
