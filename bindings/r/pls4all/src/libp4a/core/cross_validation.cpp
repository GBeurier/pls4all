...
[[nodiscard]] p4a_status_t validate_plan_fold(
    ::pls4all::core::Context& ctx,
    const ::pls4all::core::ValidationFold& fold,
...
p4a_status_t cross_validate_regression(Context& ctx,
                                       const Config& cfg,
    ...
    try {
        ...
        p4a_matrix_view_t all_predictions =
