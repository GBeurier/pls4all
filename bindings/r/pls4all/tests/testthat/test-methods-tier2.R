...
#   - external parity: pls4all vs the R `pls` package's SIMPLS for
...
# ---- External parity --------------------------------------------------
# Compare pls4all SIMPLS (via the tier-1 `pls()` wrapper, NOT
...
test_that("pls4all SIMPLS matches `pls::plsr` SIMPLS within tolerance", {
    skip_if_no_libp4a()
