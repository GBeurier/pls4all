 ...
 */
#ifndef N4M_CORE_AUG_EMSC_DISTORT_H
#define N4M_CORE_AUG_EMSC_DISTORT_H
...
typedef struct n4m_aug_emsc_distort_state_t n4m_aug_emsc_distort_state_t;
...
#endif /* N4M_CORE_AUG_EMSC_DISTORT_H */
