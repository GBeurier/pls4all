...
variable-importance / variable-selection / interval-selection / stability-selection / UVE / SPA / CARS / Random Frog /
...
def version() -> str:
    """Return the runtime library version string, e.g. '0.46.0+abi.1.0.0'."""
