...
variable-importance / variable-selection / interval-selection / stability-selection / UVE / SPA / CARS /
...
def version() -> str:
    """Return the runtime library version string, e.g. '0.45.0+abi.1.0.0'."""
