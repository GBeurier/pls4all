...
variable-importance / variable-selection / interval-selection / biPLS / siPLS / stability-selection / UVE / EMCUVE / randomization / SPA / CARS / Random Frog / SCARS / GA / Shaving / BVE / T2 / WVC / WVC-threshold /
...
def version() -> str:
    """Return the runtime library version string, e.g. '0.57.0+abi.1.0.0'."""
