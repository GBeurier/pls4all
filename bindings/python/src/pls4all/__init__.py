...
on top of the live NIPALS, SIMPLS, kernel, wide-kernel, SVD and PCR C ABI.
"""

from ._ffi import lib  # noqa: F401  — eagerly loads libp4a
from ._errors import Pls4allError
from ._types import Algorithm, Backend, Dtype, Solver, Status
from ._context import Context
from ._config import Config


def version() -> str:
    """Return the runtime library version string, e.g. '0.7.0+abi.1.0.0'."""
