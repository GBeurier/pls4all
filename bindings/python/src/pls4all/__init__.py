...
variable-importance / variable-selection / interval-selection / biPLS / siPLS / stability-selection / UVE / EMCUVE / randomization / SPA / CARS / Random Frog / SCARS / GA / Shaving / BVE / T2 / WVC /
...
def version() -> str:
    """Return the runtime library version string, e.g. '0.56.0+abi.1.0.0'."""
