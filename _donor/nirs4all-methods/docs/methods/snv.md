...
From the `n4m.SNV` Python wrapper docstring:
...
```c
n4m_status_t n4m_pp_snv_create(n4m_pp_snv_handle_t** out, int with_mean, int with_std, int ddof);
void n4m_pp_snv_destroy(n4m_pp_snv_handle_t* handle);
n4m_status_t n4m_pp_snv_transform(const n4m_pp_snv_handle_t* handle, n4m_matrix_view_t X, n4m_matrix_view_t out);
```
...
|-------|-------------|----------|----------|
| C ABI | `n4m_pp_snv` | C/C++ | Stable libn4m entry point family. |
| Python | `n4m.python.snv` | Python | ABI-close function backed by ctypes. |
| Python sklearn | `n4m.sklearn.SNV` | Python | scikit-learn-compatible estimator backed by ctypes. |
| R | `snv(X, with_mean = TRUE, with_std = TRUE, ddof = 0L)` | R | Public package wrapper around the C ABI. |
| ref.r.prospectr | `prospectr.standardNormalVariate` | R | canonical/comparator; n4m benchmark uses ddof=1 to match prospectr's sample-standard-deviation convention |
...
- ◆ **`ref.r.prospectr`** (R · canonical) — `prospectr.standardNormalVariate` · prospectr 0.2.8 — n4m benchmark uses ddof=1 to match prospectr's sample-standard-deviation convention
...
|---------|---------|------|------------|------|
| `ref.r.prospectr` | `prospectr.standardNormalVariate` | R / parity | `default_allclose` | n4m benchmark uses ddof=1 to match prospectr's sample-standard-deviation convention |
...
<tr class="bk-row"><td class="bk-name"><code>N4M.cpp</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">3.0e-14</td><td class="ms ms-best">🏆 0.006 ms</td><td class="ms ms-best">🏆 0.062 ms</td><td class="ms ms-best">🏆 0.319 ms</td></tr>
</tbody>
<tbody class="lang-band lang-python"><tr class="lang-band-row" data-lang="python"><th colspan="5" scope="rowgroup"><span class="lang-band-dot"></span>Python · nirs4all-methods</th></tr>
<tr class="bk-row"><td class="bk-name"><code>N4M.python</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">3.0e-14</td><td class="ms">0.011 ms</td><td class="ms">0.072 ms</td><td class="ms">0.333 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>N4M.sklearn</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">3.0e-14</td><td class="ms">0.014 ms</td><td class="ms">0.073 ms</td><td class="ms">0.348 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>N4M.R</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">3.0e-14</td><td class="ms">0.030 ms</td><td class="ms">0.303 ms</td><td class="ms">1.984 ms</td></tr>
</tbody>
