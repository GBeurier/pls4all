...
/*
 * GaussianAdditiveNoise — Phase 15 augmenter (n4m_aug_gaussian_noise_*).
 *
 ...
 * `n4m_pcg64_engine_standard_normal_fill(n_samples * n_features)` call so the
 ...
 */
#ifndef N4M_CORE_AUG_NOISE_GAUSSIAN_NOISE_H
#define N4M_CORE_AUG_NOISE_GAUSSIAN_NOISE_H
...
typedef struct n4m_aug_gaussian_noise_state_t n4m_aug_gaussian_noise_state_t;
...
#endif /* N4M_CORE_AUG_NOISE_GAUSSIAN_NOISE_H */
