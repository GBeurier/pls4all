 ...
 */
#ifndef N4M_CORE_PP_DERIVATIVES_NORRIS_WILLIAMS_H
#define N4M_CORE_PP_DERIVATIVES_NORRIS_WILLIAMS_H
...
typedef struct n4m_pp_norris_williams_state_t n4m_pp_norris_williams_state_t;
...
#endif /* N4M_CORE_PP_DERIVATIVES_NORRIS_WILLIAMS_H */
