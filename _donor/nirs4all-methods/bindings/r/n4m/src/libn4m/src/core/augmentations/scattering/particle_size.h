 ...
 */
#ifndef N4M_CORE_AUG_PARTICLE_SIZE_H
#define N4M_CORE_AUG_PARTICLE_SIZE_H
...
typedef struct n4m_aug_particle_size_state_t n4m_aug_particle_size_state_t;
...
#endif /* N4M_CORE_AUG_PARTICLE_SIZE_H */
