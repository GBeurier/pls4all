 ...
 */
#ifndef N4M_CORE_AUG_INSTRUMENT_BROADEN_H
#define N4M_CORE_AUG_INSTRUMENT_BROADEN_H
...
typedef struct n4m_aug_instrument_broaden_state_t
                n4m_aug_instrument_broaden_state_t;
...
#endif /* N4M_CORE_AUG_INSTRUMENT_BROADEN_H */
