 ...
 * in n4m.h and is implemented in c_api/c_api_resampling.cpp.
 *
 ...
 * N4M_ERR_NUMERICAL_FAILURE. When `bounds_error == 0` and the query is
 ...
 */
#ifndef N4M_CORE_PP_RESAMPLING_RESAMPLER_H
#define N4M_CORE_PP_RESAMPLING_RESAMPLER_H
...
typedef struct n4m_pp_resampler_state_t n4m_pp_resampler_state_t;
...
#endif /* N4M_CORE_PP_RESAMPLING_RESAMPLER_H */
