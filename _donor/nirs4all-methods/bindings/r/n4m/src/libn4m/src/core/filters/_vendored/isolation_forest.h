 ...
 * matches the n4m_filter_x_outlier_state usage.
 */
#ifndef N4M_CORE_FILTERS_VENDORED_ISOLATION_FOREST_H
#define N4M_CORE_FILTERS_VENDORED_ISOLATION_FOREST_H
...
typedef struct n4m_iforest_t n4m_iforest_t;
...
#endif /* N4M_CORE_FILTERS_VENDORED_ISOLATION_FOREST_H */
