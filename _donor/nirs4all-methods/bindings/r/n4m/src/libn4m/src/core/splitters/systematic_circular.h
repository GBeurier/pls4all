 ...
 */
#ifndef N4M_CORE_SPLITTERS_SYSTEMATIC_CIRCULAR_H
#define N4M_CORE_SPLITTERS_SYSTEMATIC_CIRCULAR_H
...
typedef struct n4m_split_syscirc_state_t {
    double   test_size;
    uint64_t seed;
} n4m_split_syscirc_state_t;
...
#endif /* N4M_CORE_SPLITTERS_SYSTEMATIC_CIRCULAR_H */
