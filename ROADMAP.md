...
Latest local tag: `phase-5g-random-frog-selection` (`0.46.0+abi.1.0.0`).

- Local reference gate is green: 75 deterministic parity fixtures, 165 C++ ABI/core tests, CLI selfcheck, Python smoke, ABI symbol diff, dependency audit, UBSAN and ASAN+UBSAN.
...
- Active implementation track: Phase 5 variable selection, next moving from Random Frog to SCARS/GA-style wrappers.
...
- Wrappers / metaheuristics: SCARS, GA-PLS, Shaving, BVE-PLS, T2-PLS, WVC-PLS.
