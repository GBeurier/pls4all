...
Latest local tag: `phase-5s-rep-selection` (`0.58.0+abi.1.0.0`).

- Local reference gate is green: 87 deterministic parity fixtures, 189 C++ ABI/core tests, CLI selfcheck, Python smoke, ABI symbol diff, dependency audit, UBSAN and ASAN+UBSAN.
...
- Active implementation track: Phase 5 variable selection, next moving to IPW/ST-PLS wrapper/metaheuristic selectors.
...
- Remaining wrappers / metaheuristics: IPW/ST-PLS.
