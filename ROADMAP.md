...
Latest local tag: `phase-6a-aom-preprocessing` (`0.61.0+abi.1.0.0`).

- Local reference gate is green: 91 deterministic parity fixtures, 195 C++ ABI/core tests, CLI selfcheck, Python smoke, ABI symbol diff, dependency audit, UBSAN and ASAN+UBSAN.
