...
Latest shipped tag: `phase-5d-uve-selection` (`0.43.0+abi.1.0.0`).

- Local reference gate is green: 72 deterministic parity fixtures, 159 C++ ABI/core tests, CLI selfcheck, Python smoke, ABI symbol diff, dependency audit, UBSAN and ASAN+UBSAN.
...
- Active implementation track: Phase 5 variable selection, next moving from UVE/MCUVE primitives to CARS/SPA/random-frog style wrappers.
