...
C4A_API c4a_status_t c4a_pp_iasls_create(c4a_pp_iasls_handle_t** out,
                                          ...
                                          int32_t polyorder,
                                          int32_t max_iter, double tol);
C4A_API c4a_status_t c4a_pp_iasls_create_ex(c4a_pp_iasls_handle_t** out,
                                             double lam, double p,
                                             double lam_1,
                                             int32_t polyorder,
                                             int32_t diff_order,
...
typedef enum c4a_pp_wavelet_features_entropy_t {
    C4A_PP_WAVELET_FEATURES_ENTROPY_ENERGY    = 0,
    C4A_PP_WAVELET_FEATURES_ENTROPY_HISTOGRAM = 1
} c4a_pp_wavelet_features_entropy_t;
