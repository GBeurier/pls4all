 ...
 *     P4A_OP_MSC, P4A_OP_DETREND_POLY, P4A_OP_SAVGOL_SMOOTH and
 ...
 * Phase 3a/3b/3c/3d implements identity, center, autoscale, Pareto scaling,
 * SNV, MSC, polynomial detrending and Savitzky-Golay smoothing/derivatives
 * with leakage-safe training statistics.
...
P4A_API const char*  p4a_get_version_string(void);    /* e.g. "0.20.0+abi.1.0.0" */
