 ...
 * Phase 3a/3b/3c/3d/3e implements identity, center, autoscale, Pareto
 * scaling, SNV, MSC, EMSC, polynomial detrending and Savitzky-Golay
 * smoothing/derivatives with leakage-safe training statistics.
...
P4A_API const char*  p4a_get_version_string(void);    /* e.g. "0.21.0+abi.1.0.0" */
