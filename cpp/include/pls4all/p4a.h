 ...
 *     P4A_DEFLATION_REGRESSION; OPLS1 / binary OPLS-DA for P4A_ALGO_OPLS
 *     or P4A_ALGO_OPLS_DA + P4A_SOLVER_NIPALS +
 ...
 * regression solver set using P4A_DEFLATION_REGRESSION; P4A_ALGO_OPLS and
 * binary P4A_ALGO_OPLS_DA with one Y target, P4A_SOLVER_NIPALS and
 * P4A_DEFLATION_ORTHOGONAL; and P4A_ALGO_PCR with P4A_SOLVER_SVD using
 * P4A_DEFLATION_REGRESSION.
 * Unsupported algorithms / solvers / deflation modes return
 * P4A_ERR_UNSUPPORTED. Later Phase 4 increments add multi-class OPLS-DA;
...
P4A_API const char*  p4a_get_version_string(void);    /* e.g. "0.14.0+abi.1.0.0" */
