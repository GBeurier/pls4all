 ...
 * P4A_SOLVER_POWER or P4A_SOLVER_RANDOMIZED_SVD, and P4A_ALGO_PCR with
...
P4A_API const char*  p4a_get_version_string(void);    /* e.g. "0.10.0+abi.1.0.0" */
