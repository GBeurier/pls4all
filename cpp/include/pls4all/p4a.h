 ...
 *   - p4a_model_fit implements dependency-free NIPALS, SIMPLS, kernel and SVD PLS
 *     regression (PLS1 / PLS2) for P4A_ALGO_PLS_REGRESSION +
 *     P4A_SOLVER_NIPALS, P4A_SOLVER_SIMPLS,
 *     P4A_SOLVER_KERNEL_ALGORITHM or P4A_SOLVER_SVD +
 ...
 * P4A_SOLVER_SIMPLS, P4A_SOLVER_KERNEL_ALGORITHM or P4A_SOLVER_SVD, and
...
P4A_API const char*  p4a_get_version_string(void);    /* e.g. "0.6.0+abi.1.0.0" */
