 ...
 * P4A_ALGO_OPLS_DA with one or more Y targets, P4A_SOLVER_NIPALS and
 ...
 * score direction from the dominant singular pair of X.T @ Y.
...
P4A_API const char*  p4a_get_version_string(void);    /* e.g. "0.15.0+abi.1.0.0" */
