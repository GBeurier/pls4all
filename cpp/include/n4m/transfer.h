...
/*
 * cpp/include/n4m/transfer.h — M6 scaffold.
 *
 * Category: transfer
 * Source of truth (post-M5 rename): pls4all's p4a.h §transfer
 * Contents: Calibration transfer (PDS, DS) + slope/bias/local-centering variants
 *
 ...
 */
#ifndef N4M_TRANSFER_H_INCLUDED
#define N4M_TRANSFER_H_INCLUDED
...
/* TODO: lift the transfer category declarations from the umbrella here. */

#ifdef __cplusplus
}  /* extern "C" */
#endif

#endif  /* N4M_TRANSFER_H_INCLUDED */
