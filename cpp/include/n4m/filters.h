...
/*
 * cpp/include/n4m/filters.h — M6 scaffold.
 *
 * Category: filters
 * Source of truth (post-M5 rename): donor's n4m.h §filter
 * Contents: Y/XOutlierFilter (iqr/zscore/mad/percentile/mahalanobis/robust_mahalanobis/pca_residual/pca_leverage/isolation_forest/lof), HighLeverage, SpectralQuality, Composite
 *
 ...
 */
#ifndef N4M_FILTERS_H_INCLUDED
#define N4M_FILTERS_H_INCLUDED
...
/* TODO: lift the filters category declarations from the umbrella here. */

#ifdef __cplusplus
}  /* extern "C" */
#endif

#endif  /* N4M_FILTERS_H_INCLUDED */
