...
/*
 * cpp/include/n4m/diagnostics.h — M6 scaffold.
 *
 * Category: diagnostics
 * Source of truth (post-M5 rename): pls4all's p4a.h §diagnostics
 * Contents: Hotelling T2, Q residuals, DModX, monitoring, approximate PRESS, one-SE rule
 *
 ...
 */
#ifndef N4M_DIAGNOSTICS_H_INCLUDED
#define N4M_DIAGNOSTICS_H_INCLUDED
...
/* TODO: lift the diagnostics category declarations from the umbrella here. */

#ifdef __cplusplus
}  /* extern "C" */
#endif

#endif  /* N4M_DIAGNOSTICS_H_INCLUDED */
