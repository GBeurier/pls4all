...
/*
 * cpp/include/n4m/selection.h — M6 scaffold.
 *
 * Category: selection
 * Source of truth (post-M5 rename): pls4all's p4a.h §selection
 * Contents: 24 variable selectors (CARS, GA, IPW, IRF, IRIV, SPA, etc.)
 *
 ...
 */
#ifndef N4M_SELECTION_H_INCLUDED
#define N4M_SELECTION_H_INCLUDED
...
/* TODO: lift the selection category declarations from the umbrella here. */

#ifdef __cplusplus
}  /* extern "C" */
#endif

#endif  /* N4M_SELECTION_H_INCLUDED */
