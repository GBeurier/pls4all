...
/*
 * cpp/include/n4m/preprocessing.h — M6 scaffold.
 *
 * Category: preprocessing
 * Source of truth (post-M5 rename): donor's n4m.h §preprocessing
 * Contents: SNV/MSC/EMSC/SG/derivatives/baselines/wavelets/OSC/EPO + signal-conversion + scaling + scatter
 *
 ...
 */
#ifndef N4M_PREPROCESSING_H_INCLUDED
#define N4M_PREPROCESSING_H_INCLUDED
...
/* TODO: lift the preprocessing category declarations from the umbrella here. */

#ifdef __cplusplus
}  /* extern "C" */
#endif

#endif  /* N4M_PREPROCESSING_H_INCLUDED */
