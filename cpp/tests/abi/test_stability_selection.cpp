...
#include "fixtures/stability_selection_fixtures.hpp"
#include "harness.hpp"
...
void check_fixture(int& failures,
    ...
    check_close_values(failures, "mean_coefficients", result.mean_coefficients, fixture.mean_coefficients);
    check_close_values(failures, "std_coefficients", result.std_coefficients, fixture.std_coefficients);
}
