...
void check_indices(int& failures,
                   ...
                   const ::n4m::test::fixtures::CarsSelectionIndexRef& expected) {
    if (actual.size() != expected.size) {
        ++failures;
        std::fprintf(stderr,
                     "  FAIL %s size: actual %lu expected %lu\n",
...
void check_fixture(int& failures,
                   const ::n4m::test::fixtures::CarsSelectionFixture& fixture) {
    ...
    ::n4m::core::CarsSelectionResult result;
    CHECK_EQ(::n4m::core::select_by_cars(ctx,
                                             cfg,
                                             X,
                                             Y,
                                             plan,
...
TEST(cars_selection_phase5f, generated_fixture_matches_python_reference) {
    for (const auto& fixture : ::n4m::test::fixtures::kCarsSelectionFixtures) {
        check_fixture(failures, fixture);
    }
}

TEST(cars_selection_phase5f, rejects_invalid_cars_requests) {
    const auto& fixture = ::n4m::test::fixtures::kCarsSelectionFixtures[0];
    ::n4m::core::Context ctx;
    ::n4m::core::Config cfg;
    cfg.n_components = fixture.n_components;
