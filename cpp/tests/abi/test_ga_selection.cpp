...
void check_indices(int& failures,
                   ...
                   const ::n4m::test::fixtures::GaSelectionIndexRef& expected) {
    if (actual.size() != expected.size) {
        ++failures;
        std::fprintf(stderr,
                     "  FAIL %s size: actual %lu expected %lu\n",
...
void check_fixture(int& failures,
                   const ::n4m::test::fixtures::GaSelectionFixture& fixture) {
    ...
    ::n4m::core::GaSelectionResult result;
    CHECK_EQ(::n4m::core::select_by_ga(ctx,
                                           cfg,
                                           X,
                                           Y,
                                           plan,
...
TEST(ga_selection_phase5i, generated_fixture_matches_python_reference) {
    for (const auto& fixture : ::n4m::test::fixtures::kGaSelectionFixtures) {
        check_fixture(failures, fixture);
    }
}

TEST(ga_selection_phase5i, rejects_invalid_ga_requests) {
    const auto& fixture = ::n4m::test::fixtures::kGaSelectionFixtures[0];
    ::n4m::core::Context ctx;
    ::n4m::core::Config cfg;
    cfg.n_components = fixture.n_components;
