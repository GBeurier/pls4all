...
void check_indices(int& failures,
                   ...
                   const ::n4m::test::fixtures::ShavingSelectionIndexRef& expected) {
    if (actual.size() != expected.size) {
        ++failures;
        std::fprintf(stderr,
                     "  FAIL %s size: actual %lu expected %lu\n",
...
void check_fixture(int& failures,
                   const ::n4m::test::fixtures::ShavingSelectionFixture& fixture) {
    ...
    ::n4m::core::ShavingSelectionResult result;
    CHECK_EQ(::n4m::core::select_by_shaving(ctx,
                                                cfg,
                                                X,
                                                Y,
                                                plan,
...
TEST(shaving_selection_phase5j, generated_fixture_matches_python_reference) {
    for (const auto& fixture : ::n4m::test::fixtures::kShavingSelectionFixtures) {
        check_fixture(failures, fixture);
    }
}

TEST(shaving_selection_phase5j, rejects_invalid_shaving_requests) {
    const auto& fixture = ::n4m::test::fixtures::kShavingSelectionFixtures[0];
    ::n4m::core::Context ctx;
    ::n4m::core::Config cfg;
    cfg.n_components = fixture.n_components;
