...
void check_fixture(int& failures,
                   const ::n4m::test::fixtures::AdvancedValidationFixture& fixture) {
    ::n4m::core::Context ctx;
    ::n4m::core::ValidationPlan plan;
    if (std::strcmp(fixture.kind, "external") == 0) {
        CHECK_EQ(::n4m::core::make_external_folds_validation_plan(ctx,
                                                                      fixture.n_samples,
        ...
        CHECK_EQ(::n4m::core::make_repeated_kfold_validation_plan(ctx,
                                                                      fixture.n_samples,
                                                                      fixture.n_splits,
                                                                      fixture.n_repeats,
                                                                      fixture.seed,
        ...
        CHECK_EQ(::n4m::core::make_kennard_stone_validation_plan(ctx,
                                                                     X,
                                                                     fixture.train_count,
                                                                     plan),
                 N4M_OK);
        ...
        CHECK_EQ(::n4m::core::make_spxy_validation_plan(ctx,
                                                            X,
                                                            Y,
                                                            fixture.train_count,
                                                            plan),
...
TEST(validation_phase3q, generated_advanced_split_fixtures_match_python_reference) {
    for (const auto& fixture : ::n4m::test::fixtures::kAdvancedValidationFixtures) {
...
TEST(validation_phase3q, rejects_invalid_advanced_split_requests) {
    ...
    CHECK_EQ(::n4m::core::make_external_folds_validation_plan(ctx, 4, nullptr, 2, plan),
             N4M_ERR_NULL_POINTER);
    CHECK_EQ(::n4m::core::make_external_folds_validation_plan(ctx, 4, bad_fold_ids, 2, plan),
             N4M_ERR_INVALID_ARGUMENT);
    CHECK_EQ(::n4m::core::make_repeated_kfold_validation_plan(ctx, 4, 2, 0, 7, plan),
             N4M_ERR_INVALID_ARGUMENT);
    CHECK_EQ(::n4m::core::make_monte_carlo_validation_plan(ctx, 4, 4, 1, 7, plan),
             N4M_ERR_INVALID_ARGUMENT);
    ...
    X.row_stride = 2;
    X.col_stride = 1;
    X.dtype = N4M_DTYPE_F64;
    CHECK_EQ(::n4m::core::make_kennard_stone_validation_plan(ctx, X, 1, plan),
             N4M_ERR_INVALID_ARGUMENT);
    ...
    CHECK_EQ(::n4m::core::make_spxy_validation_plan(ctx, X, Y, 2, plan),
             N4M_ERR_INVALID_ARGUMENT);
}
