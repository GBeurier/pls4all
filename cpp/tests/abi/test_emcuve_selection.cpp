...
void check_indices(int& failures,
                   ...
                   const ::n4m::test::fixtures::EmcuveSelectionIndexRef& expected) {
    if (actual.size() != expected.size) {
        ++failures;
        std::fprintf(stderr,
                     "  FAIL %s size: actual %lu expected %lu\n",
...
void check_fixture(int& failures,
                   const ::n4m::test::fixtures::EmcuveSelectionFixture& fixture) {
    ...
    ::n4m::core::EmcuveSelectionResult result;
    CHECK_EQ(::n4m::core::select_by_emcuve(ctx,
                                               cfg,
                                               X,
                                               Y,
                                               plan,
...
TEST(emcuve_selection_phase5n, generated_fixture_matches_python_reference) {
    for (const auto& fixture : ::n4m::test::fixtures::kEmcuveSelectionFixtures) {
        check_fixture(failures, fixture);
    }
}

TEST(emcuve_selection_phase5n, rejects_invalid_emcuve_requests) {
    const auto& fixture = ::n4m::test::fixtures::kEmcuveSelectionFixtures[0];
    ::n4m::core::Context ctx;
    ::n4m::core::Config cfg;
    cfg.n_components = fixture.n_components;
