...
void check_indices(int& failures,
                   ...
                   const ::n4m::test::fixtures::ScarsSelectionIndexRef& expected) {
    if (actual.size() != expected.size) {
        ++failures;
        std::fprintf(stderr,
                     "  FAIL %s size: actual %lu expected %lu\n",
...
void check_fixture(int& failures,
                   const ::n4m::test::fixtures::ScarsSelectionFixture& fixture) {
    ...
    ::n4m::core::ScarsSelectionResult result;
    CHECK_EQ(::n4m::core::select_by_scars(ctx,
                                              cfg,
                                              X,
                                              Y,
                                              plan,
...
TEST(scars_selection_phase5h, generated_fixture_matches_python_reference) {
    for (const auto& fixture : ::n4m::test::fixtures::kScarsSelectionFixtures) {
        check_fixture(failures, fixture);
    }
}

TEST(scars_selection_phase5h, rejects_invalid_scars_requests) {
    const auto& fixture = ::n4m::test::fixtures::kScarsSelectionFixtures[0];
    ::n4m::core::Context ctx;
    ::n4m::core::Config cfg;
    cfg.n_components = fixture.n_components;
