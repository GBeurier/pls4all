...
void check_indices(int& failures,
                   ...
                   const ::n4m::test::fixtures::SiplsSelectionIndexRef& expected) {
    if (actual.size() != expected.size) {
        ++failures;
        std::fprintf(stderr,
                     "  FAIL %s size: actual %lu expected %lu\n",
...
void check_fixture(int& failures,
                   const ::n4m::test::fixtures::SiplsSelectionFixture& fixture) {
    ...
    ::n4m::core::SiplsSelectionResult result;
    CHECK_EQ(::n4m::core::select_by_sipls(ctx,
                                              cfg,
                                              X,
                                              Y,
                                              plan,
...
TEST(sipls_selection_phase5q, generated_fixture_matches_python_reference) {
    for (const auto& fixture : ::n4m::test::fixtures::kSiplsSelectionFixtures) {
        check_fixture(failures, fixture);
    }
}

TEST(sipls_selection_phase5q, rejects_invalid_sipls_requests) {
    const auto& fixture = ::n4m::test::fixtures::kSiplsSelectionFixtures[0];
    ::n4m::core::Context ctx;
    ::n4m::core::Config cfg;
    cfg.n_components = fixture.n_components;
