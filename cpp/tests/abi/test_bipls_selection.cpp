...
#include "fixtures/bipls_selection_fixtures.hpp"
#include "harness.hpp"
...
void check_fixture(int& failures,
    ...
    check_indices(failures, "removed_intervals", result.removed_intervals, fixture.removed_intervals);
    check_indices(failures, "active_counts", result.active_counts, fixture.active_counts);
    check_close_values(failures, "rmse_path", result.rmse_path, fixture.rmse_path);
