...
// ---------------------------------------------------------------------------
// Forward declarations for the Phase 10 ABI surface.
//
// These mirror the prototypes that the central integrator will append to
// cpp/include/chemometrics4all/c4a.h §14. We forward-declare them here so
// the test TU compiles standalone in the worktree before central integration.
// Each prototype matches the matching extern "C" definition in
// cpp/src/c_api/c_api_resampling.cpp.
// ---------------------------------------------------------------------------
