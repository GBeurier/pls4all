...
//
// M4 stub — cpp/src/core/models/core/_common.hpp
//
// Category: models/core
// Origin:  DERIVED
// Lines:   DERIVED
// Function(s): Declarations for models/core/_common.cpp (linkage: extern, not anon-namespace)
//
...
#endif  // N4M_MODELS_CORE__COMMON_HPP_INCLUDED
