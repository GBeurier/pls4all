...
//
// M4 stub — cpp/src/core/models/pls/_common.cpp
//
// Category: models/pls
// Origin:  cpp/src/core/model.cpp
// Lines:   split from anon-namespace
// Function(s): simple_simpls + dominant_svd_pair + largest_symmetric_eigenvector + canonicalize_direction_sign + canonicalize_svd_pair_sign
//
// STATUS: scaffold only. The function body must be migrated from the
...
// TODO: paste the function body here, replacing this comment block.
// After extraction, ensure all referenced helpers come from
// _common.hpp (or the appropriate header) and that pls4all_core
