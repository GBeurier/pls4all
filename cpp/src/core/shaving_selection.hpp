...
//
// Internal deterministic shaving-PLS variable-selection primitive.
...
[[nodiscard]] p4a_status_t select_by_shaving(Context& ctx,
                                             const Config& cfg,
