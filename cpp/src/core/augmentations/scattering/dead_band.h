 ...
 */
#ifndef CHEMOMETRICS4ALL_CORE_AUG_DEAD_BAND_H
#define CHEMOMETRICS4ALL_CORE_AUG_DEAD_BAND_H
...
typedef struct c4a_aug_dead_band_state_t c4a_aug_dead_band_state_t;
...
#endif /* CHEMOMETRICS4ALL_CORE_AUG_DEAD_BAND_H */
