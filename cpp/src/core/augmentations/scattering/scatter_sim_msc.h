 ...
 */
#ifndef CHEMOMETRICS4ALL_CORE_AUG_SCATTER_SIM_MSC_H
#define CHEMOMETRICS4ALL_CORE_AUG_SCATTER_SIM_MSC_H
...
typedef struct c4a_aug_scatter_sim_state_t c4a_aug_scatter_sim_state_t;
...
#endif /* CHEMOMETRICS4ALL_CORE_AUG_SCATTER_SIM_MSC_H */
