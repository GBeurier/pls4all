 ...
 * `[0, 1, ..., p-1]`.
 */
#ifndef CHEMOMETRICS4ALL_CORE_AUG_WAVELENGTH_STRETCH_H
#define CHEMOMETRICS4ALL_CORE_AUG_WAVELENGTH_STRETCH_H
...
typedef struct c4a_aug_wavelength_stretch_state_t c4a_aug_wavelength_stretch_state_t;

c4a_aug_wavelength_stretch_state_t* c4a_aug_wavelength_stretch_state_new(
    c4a_rng_pcg64* rng,
    double stretch_lo, double stretch_hi,
    const double* wavelengths, int64_t n_wavelengths);

void c4a_aug_wavelength_stretch_state_free(
    c4a_aug_wavelength_stretch_state_t* state);

c4a_status_t c4a_aug_wavelength_stretch_state_apply(
    c4a_aug_wavelength_stretch_state_t* state,
...
#endif /* CHEMOMETRICS4ALL_CORE_AUG_WAVELENGTH_STRETCH_H */
