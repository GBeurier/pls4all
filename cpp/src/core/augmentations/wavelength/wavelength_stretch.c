...
struct c4a_aug_wavelength_stretch_state_t {
...
c4a_aug_wavelength_stretch_state_t* c4a_aug_wavelength_stretch_state_new(
    ...
    c4a_aug_wavelength_stretch_state_t* s =
        (c4a_aug_wavelength_stretch_state_t*)malloc(sizeof(*s));
...
c4a_status_t c4a_aug_wavelength_stretch_state_apply(
    ...
    for (int64_t i = 0; i < rows; ++i) {
        factors[i] = c4a_aug_uniform(state->rng,
