 ...
 *
 * Internal-only; the public wrapper lives in n4m_api_signal_type.cpp.
 */
#ifndef N4M_CORE_UTILITIES_SIGNAL_TYPE_DETECTOR_H
#define N4M_CORE_UTILITIES_SIGNAL_TYPE_DETECTOR_H
 ...
 *
 * Returns N4M_OK on success, N4M_ERR_NULL_POINTER if any required output
 * pointer is NULL, N4M_ERR_INVALID_ARGUMENT for negative dimensions.
 */
n4m_status_t n4m_signal_detect_impl(const double* X,
...
#endif /* N4M_CORE_UTILITIES_SIGNAL_TYPE_DETECTOR_H */
