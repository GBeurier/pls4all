 ...
 */
#ifndef CHEMOMETRICS4ALL_CORE_UTILITIES_Q_RESIDUALS_H
#define CHEMOMETRICS4ALL_CORE_UTILITIES_Q_RESIDUALS_H
...
#endif /* CHEMOMETRICS4ALL_CORE_UTILITIES_Q_RESIDUALS_H */
