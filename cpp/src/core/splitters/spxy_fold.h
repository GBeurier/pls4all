 ...
 * K-Fold via `use_y == 0`). Public ABI lives in c4a.h §15.
 *
 ...
 */
#ifndef CHEMOMETRICS4ALL_CORE_SPLITTERS_SPXY_FOLD_H
#define CHEMOMETRICS4ALL_CORE_SPLITTERS_SPXY_FOLD_H
...
#endif /* CHEMOMETRICS4ALL_CORE_SPLITTERS_SPXY_FOLD_H */
