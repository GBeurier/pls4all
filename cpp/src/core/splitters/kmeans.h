 ...
 * c4a.h §15. Uses a vendored k-means++ initialisation + Lloyd iterations.
 *
 ...
 */
#ifndef CHEMOMETRICS4ALL_CORE_SPLITTERS_KMEANS_H
#define CHEMOMETRICS4ALL_CORE_SPLITTERS_KMEANS_H
...
typedef struct c4a_split_kmeans_state_t {
    double   test_size;
    uint64_t seed;
    int32_t  max_iter;
} c4a_split_kmeans_state_t;
...
#endif /* CHEMOMETRICS4ALL_CORE_SPLITTERS_KMEANS_H */
