...
struct n4m_pp_gaussian_state_t {
    double                 sigma;
    int32_t                order;
...
n4m_pp_gaussian_state_t* n4m_pp_gaussian_state_new(
    ...
    n4m_pp_gaussian_state_t* s =
        (n4m_pp_gaussian_state_t*)malloc(sizeof(*s));
    if (s == NULL) {
        return NULL;
    }
    s->sigma    = sigma;
...
n4m_status_t n4m_pp_gaussian_state_apply(
    ...
    n4m_pad_mode_t pad = N4M_PAD_REFLECT;
    switch (state->mode) {
        case N4M_PP_GAUSSIAN_REFLECT:  pad = N4M_PAD_REFLECT;  break;
        case N4M_PP_GAUSSIAN_CONSTANT: pad = N4M_PAD_CONSTANT; break;
        case N4M_PP_GAUSSIAN_NEAREST:  pad = N4M_PAD_NEAREST;  break;
        case N4M_PP_GAUSSIAN_MIRROR:   pad = N4M_PAD_MIRROR;   break;
        case N4M_PP_GAUSSIAN_WRAP:     pad = N4M_PAD_WRAP;     break;
