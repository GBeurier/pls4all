 ...
 *   - entropy : Shannon entropy of the squared-coefficient distribution
 *                 (zeros contribute 0 by convention; matches the nirs4all
 *                  reference).
 *
 ...
 */
#ifndef CHEMOMETRICS4ALL_CORE_PP_WAVELETS_WAVELET_FEATURES_H
#define CHEMOMETRICS4ALL_CORE_PP_WAVELETS_WAVELET_FEATURES_H
...
typedef struct c4a_pp_wavelet_features_state_t c4a_pp_wavelet_features_state_t;
...
#endif /* CHEMOMETRICS4ALL_CORE_PP_WAVELETS_WAVELET_FEATURES_H */
