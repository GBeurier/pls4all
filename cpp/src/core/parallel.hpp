...
//
//   C4A_PARALLEL_FOR_STATIC
//     -> `#pragma omp parallel for schedule(static)` when
//        C4A_USE_OPENMP is defined.
...
#ifndef CHEMOMETRICS4ALL_CORE_PARALLEL_HPP
#define CHEMOMETRICS4ALL_CORE_PARALLEL_HPP
...
//   older releases.
#    define C4A_PARALLEL_FOR_STATIC __pragma(omp parallel for schedule(static))
#  else
#    define C4A_PARALLEL_FOR_STATIC _Pragma("omp parallel for schedule(static)")
#  endif
#else
#  define C4A_PARALLEL_FOR_STATIC
#endif

#endif  // CHEMOMETRICS4ALL_CORE_PARALLEL_HPP
