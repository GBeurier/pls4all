...
//   older releases.
#    define P4A_PARALLEL_FOR_STATIC __pragma(omp parallel for schedule(static))
#  else
#    define P4A_PARALLEL_FOR_STATIC _Pragma("omp parallel for schedule(static)")
#  endif
#else
#  define P4A_PARALLEL_FOR_STATIC
#endif
