...
struct n4m_aug_wavelength_shift_state_t {
...
n4m_aug_wavelength_shift_state_t* n4m_aug_wavelength_shift_state_new(
    ...
    n4m_aug_wavelength_shift_state_t* s =
        (n4m_aug_wavelength_shift_state_t*)malloc(sizeof(*s));
...
n4m_status_t n4m_aug_wavelength_shift_state_apply(
    ...
    for (int64_t i = 0; i < rows; ++i) {
        shifts[i] = n4m_aug_uniform(state->rng, state->shift_lo, state->shift_hi);
    }
    for (int64_t i = 0; i < rows; ++i) {
