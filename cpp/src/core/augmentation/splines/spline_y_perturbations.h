 ...
 * Pure C. INTERNAL.
 */
#ifndef N4M_CORE_AUGMENT_SPLINE_Y_PERTURB_H
#define N4M_CORE_AUGMENT_SPLINE_Y_PERTURB_H
...
typedef struct n4m_aug_spline_y_perturb_state_t
    n4m_aug_spline_y_perturb_state_t;
...
#endif /* N4M_CORE_AUGMENT_SPLINE_Y_PERTURB_H */
