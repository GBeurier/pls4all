...
spec <- pls_pls4all_reg(num_comp = 4) %>%
    set_engine("pls4all", algorithm = "random_subspace_pls") %>%
    set_mode("regression")
...
lrn <- lrn("regr.pls4all", algorithm = "random_subspace_pls", n_components = 4L)
lrn$train(task)
```
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-drift">≈</td><td class="ms">1.50 ms</td><td class="ms ms-empty">—</td><td class="ms">5.59 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.17 ms</td><td class="ms ms-empty">—</td><td class="ms">5.51 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.22 ms</td><td class="ms ms-empty">—</td><td class="ms">6.00 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">1.15 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-empty">—</td><td class="ms">5.70 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-drift">≈</td><td class="ms">1.54 ms</td><td class="ms ms-empty">—</td><td class="ms">5.87 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms">1.31 ms</td><td class="ms ms-best">166.6 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">4.89 ms<span class="medal" title="fastest">🏆</span></td></tr>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.R</code></td><td class="parity parity-drift">≈</td><td class="ms">5.50 ms</td><td class="ms ms-empty">—</td><td class="ms">22.0 ms</td></tr>
