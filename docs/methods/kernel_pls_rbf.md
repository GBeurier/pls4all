...
Structural validation contract for `kernel_pls_rbf`, exported by the declarative validation framework (`benchmarks/validation/registry/`) from `benchmarks.parity_timing.registry`. Regenerated by `python -m benchmarks.validation.export_registry --write`.
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms ms-best">1.40 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">12.2 ms</td><td class="ms">61.6 ms</td><td class="ms">514.5 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">1.42 ms</td><td class="ms ms-best">12.0 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">61.5 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">519.5 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">1.44 ms</td><td class="ms">12.1 ms</td><td class="ms">61.7 ms</td><td class="ms">520.7 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">1.43 ms</td><td class="ms">12.1 ms</td><td class="ms">61.8 ms</td><td class="ms">518.6 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">1.40 ms</td><td class="ms">12.2 ms</td><td class="ms">61.9 ms</td><td class="ms ms-best">503.2 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.sklearn</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">2.07 ms</td><td class="ms">12.3 ms</td><td class="ms">61.8 ms</td><td class="ms">522.3 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.R</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">3.94 ms</td><td class="ms">52.1 ms</td><td class="ms">408.2 ms</td><td class="ms">895.8 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.formula</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">5.21 ms</td><td class="ms">79.7 ms</td><td class="ms">597.9 ms</td><td class="ms">1.1 s</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.mdatools</code></td><td class="parity parity-divergence parity-drift">3e-10</td><td class="ms">5.12 ms</td><td class="ms">64.9 ms</td><td class="ms">592.3 ms</td><td class="ms">1.2 s</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.pls</code></td><td class="parity parity-divergence parity-drift">3e-10</td><td class="ms">5.38 ms</td><td class="ms">72.5 ms</td><td class="ms">586.5 ms</td><td class="ms">1.1 s</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">2.14 ms</td><td class="ms">17.1 ms</td><td class="ms">85.6 ms</td><td class="ms">568.6 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab.classdef</code></td><td class="parity parity-divergence parity-divergent">0.16</td><td class="ms">2.82 ms</td><td class="ms">18.3 ms</td><td class="ms">86.8 ms</td><td class="ms">564.7 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): kernlab+pls 0.9.33+2.8.5 — qualitative (rmse_rel ≤ 2e+00)">📐</span><code>ref.r_kernlab_pls</code></td><td class="parity parity-divergence parity-ref-source">0</td><td class="ms">20.9 ms</td><td class="ms">113.5 ms</td><td class="ms">1.0 s</td><td class="ms">1.3 s</td></tr>
</tbody>
</table>
</div>
