...
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">1.38 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">169.8 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">4.80 ms<span class="medal" title="fastest">🏆</span></td></tr>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): multiblock 0.8.10 — qualitative (rmse_rel ≤ 1e+00)">📐</span><code>ref.r_multiblock</code></td><td class="parity parity-drift">≈</td><td class="ms">1.2 s</td><td class="ms">903.4 ms</td><td class="ms">1.2 s</td></tr>
