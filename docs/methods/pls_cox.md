...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-exact">✓ 9e-01</td><td class="ms">1.11 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-exact">✓ 9e-01</td><td class="ms">1.00 ms</td></tr>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.sklearn</code></td><td class="parity parity-exact">✓ 5e-16</td><td class="ms">1.21 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab.classdef</code></td><td class="parity parity-exact">✓ bind</td><td class="ms">4.87 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): plsRcox 1.8.2 — qualitative (rmse_rel ≤ 5e+00)">📐</span><code>ref.r_plsrcox</code></td><td class="parity parity-exact">✓ ref</td><td class="ms">1.9 s</td></tr>
