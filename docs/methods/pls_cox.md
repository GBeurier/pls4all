...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-drift">≈</td><td class="ms">1.00 ms</td><td class="ms ms-empty">—</td><td class="ms">4.86 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">0.92 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-empty">—</td><td class="ms ms-best">4.40 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.24 ms</td><td class="ms ms-empty">—</td><td class="ms">4.56 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-drift">≈</td><td class="ms">0.96 ms</td><td class="ms ms-empty">—</td><td class="ms">4.52 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-drift">≈</td><td class="ms">0.97 ms</td><td class="ms ms-empty">—</td><td class="ms">4.83 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms">1.91 ms</td><td class="ms ms-best">168.0 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">6.46 ms</td></tr>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): plsRcox 1.8.2 — qualitative (rmse_rel ≤ 5e+00)">📐</span><code>ref.r_plsrcox</code></td><td class="parity parity-drift">≈</td><td class="ms">2.5 s</td><td class="ms">2.0 s</td><td class="ms">2.6 s</td></tr>
