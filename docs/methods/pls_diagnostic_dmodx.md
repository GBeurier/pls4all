...
<tr class="bk-row"><td class="bk-name"><code>pls4all.R</code></td><td class="parity parity-exact">✓ 7e-16</td><td class="ms">3.00 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.formula</code></td><td class="parity parity-exact">✓ 7e-16</td><td class="ms">4.00 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab</code></td><td class="parity parity-exact">✓ 7e-16</td><td class="ms">1.79 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab.classdef</code></td><td class="parity parity-exact">✓ 7e-16</td><td class="ms">4.53 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): mdatools 0.15.0 — qualitative (rmse_rel ≤ 5e+00)">📐</span><code>ref.r_mdatools</code></td><td class="parity parity-exact">✓ ref</td><td class="ms">334.3 ms</td></tr>
