...
p4a_pls_diagnostic_q_fit(ctx, cfg, &x_view, &y_view, /* hyperparams */, &res);
...
```python
import pls4all
from pls4all._methods import pls_diagnostic_q_fit
with pls4all.Context() as ctx, pls4all.Config() as cfg:
    res = pls_diagnostic_q_fit(ctx, cfg, X, y, n_components=4)
...
```matlab
res  = pls4all.fit("pls_diagnostic_q", X, y, "NumComponents", 4);
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-exact">✓ 7e-16</td><td class="ms ms-best">1.04 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-exact">✓ 7e-16</td><td class="ms">1.07 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-exact">✓ 8e-16</td><td class="ms">1.22 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-exact">✓ 8e-16</td><td class="ms">1.06 ms</td></tr>
</tbody>
<tbody class="lang-band lang-python"><tr class="lang-band-row" data-lang="python"><th colspan="3" scope="rowgroup"><span class="lang-band-dot"></span>Python · pls4all</th></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-exact">✓ bind</td><td class="ms">1.10 ms</td></tr>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.sklearn</code></td><td class="parity parity-error">⚠</td><td class="ms">—</td></tr>
</tbody>
<tbody class="lang-band lang-r"><tr class="lang-band-row" data-lang="r"><th colspan="3" scope="rowgroup"><span class="lang-band-dot"></span>R · pls4all</th></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R</code></td><td class="parity parity-exact">✓ 8e-14</td><td class="ms">3.00 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.formula</code></td><td class="parity parity-exact">✓ 8e-14</td><td class="ms">3.00 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab</code></td><td class="parity parity-exact">✓ 8e-14</td><td class="ms">1.63 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab.classdef</code></td><td class="parity parity-exact">✓ 8e-14</td><td class="ms">4.21 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): mdatools 0.15.0 — qualitative (rmse_rel ≤ 5e+00)">📐</span><code>ref.r_mdatools</code></td><td class="parity parity-exact">✓ ref</td><td class="ms">328.6 ms</td></tr>
