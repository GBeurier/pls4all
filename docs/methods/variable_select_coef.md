...
mdl = CoefficientSelector(top_k, n_components=2, solver='nipals', center_x=True, scale_x=True, tol=1e-06, max_iter=500)
mdl.fit(X, y)
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">1.65 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">677.6 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">4.54 ms<span class="medal" title="fastest">🏆</span></td></tr>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): pls 2.8.5 — qualitative (rmse_rel ≤ 1e+00)">📐</span><code>ref.r_pls</code></td><td class="parity parity-drift">≈</td><td class="ms">426.8 ms</td><td class="ms">294.0 ms</td><td class="ms">455.9 ms</td></tr>
