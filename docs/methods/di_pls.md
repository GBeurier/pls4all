...
Structural validation contract for `di_pls`, exported by the declarative validation framework (`benchmarks/validation/registry/`) from `benchmarks.parity_timing.registry`. Regenerated by `python -m benchmarks.validation.export_registry --write`.
...
| Reference tolerance | `2e-02` (relaxed) |
...
**Reference gate**: relaxed diagnostic only — this does not validate release parity (`rmse_rel ≤ 2e-02`).
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-divergence parity-not_available">—</td><td class="ms">1.02 ms</td><td class="ms">9.29 ms</td><td class="ms ms-best">42.1 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">83.7 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-divergence parity-divergent">2.1e-02</td><td class="ms">1.02 ms</td><td class="ms">8.68 ms</td><td class="ms">43.2 ms</td><td class="ms">83.9 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-divergence parity-not_available">—</td><td class="ms ms-best">1.02 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">8.30 ms</td><td class="ms">42.6 ms</td><td class="ms">85.1 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-divergence parity-not_available">—</td><td class="ms">1.04 ms</td><td class="ms ms-best">8.30 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">43.3 ms</td><td class="ms">84.2 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-divergence parity-divergent">2.1e-02</td><td class="ms">1.06 ms</td><td class="ms">9.22 ms</td><td class="ms">42.7 ms</td><td class="ms ms-best">83.6 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.sklearn</code></td><td class="parity parity-divergence parity-divergent">2.1e-02</td><td class="ms">1.26 ms</td><td class="ms">8.57 ms</td><td class="ms">43.3 ms</td><td class="ms">88.0 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.R</code></td><td class="parity parity-divergence parity-divergent">2.1e-02</td><td class="ms">6.73 ms</td><td class="ms">96.6 ms</td><td class="ms">954.2 ms</td><td class="ms">1.0 s</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.formula</code></td><td class="parity parity-divergence parity-divergent">2.1e-02</td><td class="ms">9.36 ms</td><td class="ms">129.4 ms</td><td class="ms">1.1 s</td><td class="ms">1.0 s</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.mdatools</code></td><td class="parity parity-divergence parity-divergent">3.3e-03</td><td class="ms">7.94 ms</td><td class="ms">129.1 ms</td><td class="ms">1.1 s</td><td class="ms">1.1 s</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.pls</code></td><td class="parity parity-divergence parity-divergent">3.3e-03</td><td class="ms">9.23 ms</td><td class="ms">124.0 ms</td><td class="ms">1.1 s</td><td class="ms">1.0 s</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab</code></td><td class="parity parity-divergence parity-divergent">2.1e-02</td><td class="ms">3.29 ms</td><td class="ms">26.2 ms</td><td class="ms">131.3 ms</td><td class="ms">255.2 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab.classdef</code></td><td class="parity parity-divergence parity-divergent">2.1e-02</td><td class="ms">3.95 ms</td><td class="ms">26.7 ms</td><td class="ms">131.0 ms</td><td class="ms">258.2 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-relaxed"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (python): diPLSlib 2.5.0 — relaxed (rmse_rel ≤ 2e-02)">📐</span><code>ref.python_diplslib</code></td><td class="parity parity-divergence parity-ref-source">0</td><td class="ms">4.69 ms</td><td class="ms">198.7 ms</td><td class="ms">50.7 s</td><td class="ms">359.5 ms</td></tr>
</tbody>
</table>
</div>
