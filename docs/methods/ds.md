...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-drift">≈</td><td class="ms">1.91 ms</td><td class="ms ms-empty">—</td><td class="ms">6.24 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.59 ms</td><td class="ms ms-empty">—</td><td class="ms">6.27 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">1.24 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-empty">—</td><td class="ms ms-best">6.07 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-drift">≈</td><td class="ms">1.41 ms</td><td class="ms ms-empty">—</td><td class="ms">7.46 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-drift">≈</td><td class="ms">1.40 ms</td><td class="ms ms-empty">—</td><td class="ms">6.30 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms">1.32 ms</td><td class="ms">166.4 ms</td><td class="ms">6.94 ms</td></tr>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): base R 4.3.3 — qualitative (rmse_rel ≤ 5e-01)">📐</span><code>ref.r_base</code></td><td class="parity parity-drift">≈</td><td class="ms">180.8 ms</td><td class="ms ms-best">139.2 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">246.8 ms</td></tr>
