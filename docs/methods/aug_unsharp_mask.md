...
From the `n4m.UnsharpMask` Python wrapper docstring:
...
```c
n4m_status_t n4m_aug_unsharp_mask_apply( const n4m_aug_unsharp_mask_handle_t* handle, n4m_matrix_view_t X, n4m_matrix_view_t out);
n4m_status_t n4m_aug_unsharp_mask_create( n4m_aug_unsharp_mask_handle_t** out, n4m_rng_pcg64_state_t* rng, double amount_lo, double amount_hi, double sigma, int32_t kernel_width);
void n4m_aug_unsharp_mask_destroy(n4m_aug_unsharp_mask_handle_t* handle);
```
...
|-------|-------------|----------|----------|
| C ABI | `n4m_aug_unsharp_mask` | C/C++ | Stable libn4m entry point family. |
| Python | `n4m.python.aug_unsharp_mask` | Python | ABI-close function backed by ctypes. |
| Python sklearn | `n4m.sklearn.UnsharpMask` | Python | scikit-learn-compatible estimator backed by ctypes. |
...
<tr class="bk-row"><td class="bk-name"><code>N4M.cpp</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">2.2e-16</td><td class="ms ms-best">🏆 0.034 ms</td><td class="ms">0.252 ms</td><td class="ms ms-best">🏆 1.216 ms</td></tr>
</tbody>
<tbody class="lang-band lang-python"><tr class="lang-band-row" data-lang="python"><th colspan="5" scope="rowgroup"><span class="lang-band-dot"></span>Python · nirs4all-methods</th></tr>
<tr class="bk-row"><td class="bk-name"><code>N4M.python</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">2.2e-16</td><td class="ms">0.035 ms</td><td class="ms">0.254 ms</td><td class="ms">1.334 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>N4M.sklearn</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">2.2e-16</td><td class="ms">0.038 ms</td><td class="ms ms-best">🏆 0.247 ms</td><td class="ms">1.261 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>N4M.R</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">6.7e-16</td><td class="ms">0.048 ms</td><td class="ms">0.310 ms</td><td class="ms">1.938 ms</td></tr>
</tbody>
