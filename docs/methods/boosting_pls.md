...
spec <- pls_pls4all_reg(num_comp = 4) %>%
    set_engine("pls4all", algorithm = "boosting_pls") %>%
    set_mode("regression")
...
lrn <- lrn("regr.pls4all", algorithm = "boosting_pls", n_components = 4L)
lrn$train(task)
```
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-drift">≈</td><td class="ms">2.02 ms</td><td class="ms ms-empty">—</td><td class="ms">11.8 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.93 ms</td><td class="ms ms-empty">—</td><td class="ms">9.61 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.97 ms</td><td class="ms ms-empty">—</td><td class="ms">10.1 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-drift">≈</td><td class="ms">1.90 ms</td><td class="ms ms-empty">—</td><td class="ms">13.4 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-drift">≈</td><td class="ms">1.91 ms</td><td class="ms ms-empty">—</td><td class="ms">9.40 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">1.33 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">177.6 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">8.99 ms<span class="medal" title="fastest">🏆</span></td></tr>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.R</code></td><td class="parity parity-drift">≈</td><td class="ms">4.00 ms</td><td class="ms ms-empty">—</td><td class="ms">21.5 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.formula</code></td><td class="parity parity-drift">≈</td><td class="ms">7.00 ms</td><td class="ms ms-empty">—</td><td class="ms">34.5 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab.classdef</code></td><td class="parity parity-drift">≈</td><td class="ms">7.92 ms</td><td class="ms ms-empty">—</td><td class="ms">19.8 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): mboost 2.9-11 — qualitative (rmse_rel ≤ 1e+01)">📐</span><code>ref.r_mboost</code></td><td class="parity parity-drift">≈</td><td class="ms">797.5 ms</td><td class="ms">636.4 ms</td><td class="ms">830.1 ms</td></tr>
