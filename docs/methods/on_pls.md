...
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">2.08 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">177.4 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">5.07 ms<span class="medal" title="fastest">🏆</span></td></tr>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (python): OnPLS github tomlof/OnPLS — qualitative (rmse_rel ≤ 1e+01)">📐</span><code>ref.python_onpls</code></td><td class="parity parity-drift">≈</td><td class="ms">10.4 ms</td><td class="ms">24.4 ms</td><td class="ms">24.3 ms</td></tr>
