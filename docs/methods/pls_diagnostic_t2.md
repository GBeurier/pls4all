...
p4a_pls_diagnostic_t2_fit(ctx, cfg, &x_view, &y_view, /* hyperparams */, &res);
...
```python
import pls4all
from pls4all._methods import pls_diagnostic_t2_fit
with pls4all.Context() as ctx, pls4all.Config() as cfg:
    res = pls_diagnostic_t2_fit(ctx, cfg, X, y, n_components=4)
...
```matlab
res  = pls4all.fit("pls_diagnostic_t2", X, y, "NumComponents", 4);
