...
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-exact">✓ ref</td><td class="ms ms-best">169.8 ms<span class="medal" title="fastest">🏆</span></td></tr>
</tbody>
</table>
</div>
