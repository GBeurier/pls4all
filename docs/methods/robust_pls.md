...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-drift">≈</td><td class="ms">2.55 ms</td><td class="ms ms-empty">—</td><td class="ms">7.20 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-drift">≈</td><td class="ms">2.19 ms</td><td class="ms ms-empty">—</td><td class="ms">7.98 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.65 ms</td><td class="ms ms-empty">—</td><td class="ms">7.53 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-drift">≈</td><td class="ms">1.46 ms</td><td class="ms ms-empty">—</td><td class="ms">7.01 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-drift">≈</td><td class="ms">1.43 ms</td><td class="ms ms-empty">—</td><td class="ms">6.80 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">1.39 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">186.1 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">5.31 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.sklearn</code></td><td class="parity parity-drift">≈</td><td class="ms">2.30 ms</td><td class="ms ms-empty">—</td><td class="ms">7.17 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.R</code></td><td class="parity parity-drift">≈</td><td class="ms">5.00 ms</td><td class="ms ms-empty">—</td><td class="ms">19.5 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.formula</code></td><td class="parity parity-drift">≈</td><td class="ms">8.00 ms</td><td class="ms ms-empty">—</td><td class="ms">27.0 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab</code></td><td class="parity parity-drift">≈</td><td class="ms">2.69 ms</td><td class="ms ms-empty">—</td><td class="ms">9.79 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab.classdef</code></td><td class="parity parity-drift">≈</td><td class="ms">6.77 ms</td><td class="ms ms-empty">—</td><td class="ms">13.1 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): chemometrics 0.7.x — qualitative (rmse_rel ≤ 2e+00)">📐</span><code>ref.r_chemometrics</code></td><td class="parity parity-drift">≈</td><td class="ms">244.2 ms</td><td class="ms">217.5 ms</td><td class="ms">281.4 ms</td></tr>
