...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-drift">≈</td><td class="ms">0.98 ms</td><td class="ms ms-empty">—</td><td class="ms">4.54 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.79 ms</td><td class="ms ms-empty">—</td><td class="ms ms-best">4.23 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-drift">≈</td><td class="ms">0.95 ms</td><td class="ms ms-empty">—</td><td class="ms">4.70 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">0.93 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-empty">—</td><td class="ms">4.23 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-drift">≈</td><td class="ms">0.95 ms</td><td class="ms ms-empty">—</td><td class="ms">4.60 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms">1.09 ms</td><td class="ms ms-best">185.9 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">5.90 ms</td></tr>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): sgPLS 1.8.1 — qualitative (rmse_rel ≤ 1e+01)">📐</span><code>ref.r_sgpls</code></td><td class="parity parity-drift">≈</td><td class="ms">1.4 s</td><td class="ms">1.1 s</td><td class="ms">1.5 s</td></tr>
