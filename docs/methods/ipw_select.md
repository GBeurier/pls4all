...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-drift">≈ +2e+00</td><td class="ms ms-best">1.15 ms<span class="medal" title="fastest">🏆</span></td></tr>
