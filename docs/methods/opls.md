...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-drift">≈</td><td class="ms">1.00 ms</td><td class="ms ms-empty">—</td><td class="ms">5.70 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-drift">≈</td><td class="ms">0.92 ms</td><td class="ms ms-empty">—</td><td class="ms">5.47 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-drift">≈</td><td class="ms">1.10 ms</td><td class="ms ms-empty">—</td><td class="ms">4.70 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-drift">≈</td><td class="ms">1.71 ms</td><td class="ms ms-empty">—</td><td class="ms">5.64 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">0.91 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-empty">—</td><td class="ms ms-best">4.36 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms">1.29 ms</td><td class="ms ms-best">165.4 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">5.09 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.sklearn</code></td><td class="parity parity-drift">≈</td><td class="ms">1.40 ms</td><td class="ms ms-empty">—</td><td class="ms">5.94 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-relaxed"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): ropls Bioc — relaxed (rmse_rel ≤ 1e-03)">📐</span><code>ref.r_ropls</code></td><td class="parity parity-drift">≈</td><td class="ms">4.3 s</td><td class="ms">3.1 s</td><td class="ms">4.8 s</td></tr>
<tr class="bk-row"><td class="bk-name"><code>ropls</code></td><td class="parity parity-not_run">—</td><td class="ms">—</td><td class="ms ms-empty">—</td><td class="ms">—</td></tr>
</tbody>
