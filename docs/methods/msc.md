...
From the `n4m.MSC` Python wrapper docstring:
...
```c
n4m_status_t n4m_pp_msc_create(n4m_pp_msc_handle_t** out);
void n4m_pp_msc_destroy(n4m_pp_msc_handle_t* handle);
n4m_status_t n4m_pp_msc_fit(n4m_pp_msc_handle_t* handle, n4m_matrix_view_t X);
n4m_status_t n4m_pp_msc_inverse_transform( const n4m_pp_msc_handle_t* handle, n4m_matrix_view_t X, n4m_matrix_view_t out);
n4m_status_t n4m_pp_msc_is_fitted(const n4m_pp_msc_handle_t* handle, int* out_fitted);
n4m_status_t n4m_pp_msc_transform(n4m_pp_msc_handle_t* handle, n4m_matrix_view_t X, n4m_matrix_view_t out);
```
...
|-------|-------------|----------|----------|
| C ABI | `n4m_pp_msc` | C/C++ | Stable libn4m entry point family. |
| Python | `n4m.python.msc` | Python | ABI-close function backed by ctypes. |
| Python sklearn | `n4m.sklearn.MSC` | Python | scikit-learn-compatible estimator backed by ctypes. |
| R | `msc(X, X_fit = X)` | R | Public package wrapper around the C ABI. |
| ref.r.prospectr | `prospectr.msc` | R | canonical/comparator; n4m MSC follows the conventional row-wise reference-spectrum contract used by prospectr |
...
- ◆ **`ref.r.prospectr`** (R · canonical) — `prospectr.msc` · prospectr 0.2.8 — n4m MSC follows the conventional row-wise reference-spectrum contract used by prospectr
...
|---------|---------|------|------------|------|
| `ref.r.prospectr` | `prospectr.msc` | R / parity | `default_allclose` | n4m MSC follows the conventional row-wise reference-spectrum contract used by prospectr |
...
<tr class="bk-row"><td class="bk-name"><code>N4M.cpp</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">8.0e-15</td><td class="ms ms-best">🏆 0.013 ms</td><td class="ms ms-best">🏆 0.080 ms</td><td class="ms">0.384 ms</td></tr>
</tbody>
<tbody class="lang-band lang-python"><tr class="lang-band-row" data-lang="python"><th colspan="5" scope="rowgroup"><span class="lang-band-dot"></span>Python · nirs4all-methods</th></tr>
<tr class="bk-row"><td class="bk-name"><code>N4M.python</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">8.0e-15</td><td class="ms">0.015 ms</td><td class="ms">0.082 ms</td><td class="ms ms-best">🏆 0.380 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>N4M.sklearn</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">8.0e-15</td><td class="ms">0.015 ms</td><td class="ms">0.080 ms</td><td class="ms">0.382 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>N4M.R</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">8.0e-15</td><td class="ms">0.101 ms</td><td class="ms">0.699 ms</td><td class="ms">4.500 ms</td></tr>
</tbody>
