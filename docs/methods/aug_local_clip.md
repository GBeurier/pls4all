...
From the `n4m.LocalClip` Python wrapper docstring:
...
```c
n4m_status_t n4m_aug_local_clip_apply( const n4m_aug_local_clip_handle_t* handle, n4m_matrix_view_t X, n4m_matrix_view_t out);
n4m_status_t n4m_aug_local_clip_create( n4m_aug_local_clip_handle_t** out, n4m_rng_pcg64_state_t* rng, int32_t n_regions, int32_t width_lo, int32_t width_hi);
void n4m_aug_local_clip_destroy(n4m_aug_local_clip_handle_t* handle);
```
...
|-------|-------------|----------|----------|
| C ABI | `n4m_aug_local_clip` | C/C++ | Stable libn4m entry point family. |
| Python | `n4m.python.aug_local_clip` | Python | ABI-close function backed by ctypes. |
| Python sklearn | `n4m.sklearn.LocalClip` | Python | scikit-learn-compatible estimator backed by ctypes. |
...
<tr class="bk-row"><td class="bk-name"><code>N4M.cpp</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">0</td><td class="ms">0.016 ms</td><td class="ms ms-best">🏆 0.023 ms</td><td class="ms ms-best">🏆 0.075 ms</td></tr>
</tbody>
<tbody class="lang-band lang-python"><tr class="lang-band-row" data-lang="python"><th colspan="5" scope="rowgroup"><span class="lang-band-dot"></span>Python · nirs4all-methods</th></tr>
<tr class="bk-row"><td class="bk-name"><code>N4M.python</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">0</td><td class="ms">0.015 ms</td><td class="ms">0.025 ms</td><td class="ms">0.079 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>N4M.sklearn</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">0</td><td class="ms ms-best">🏆 0.015 ms</td><td class="ms">0.024 ms</td><td class="ms">0.076 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>N4M.R</code></td><td class="parity parity-divergence parity-exact" title="worst reference max abs diff over visible sizes">5.6e-16</td><td class="ms">0.031 ms</td><td class="ms">0.195 ms</td><td class="ms">1.023 ms</td></tr>
</tbody>
