...
> **Registry note** — R `plsVarSel::SR` on `pls::plsr(method='simpls')`. The solver mismatch is fixed, but plsVarSel computes SR from the regression-coefficient projection while pls4all uses stored score/loading reconstruction energy. Mask RMSE-rel ~0=perfect, ~1=half disagree, ~1.41=disjoint; tolerance accepts the documented SR-formula divergence.
...
- 📐 **`ref.r_plsvarsel`** (R · r) — `plsVarSel` 0.10.0 · qualitative (rmse_rel ≤ 1e+00) — R `plsVarSel::SR` selectivity ratio on a fitted `pls::plsr` model. Top-k indices.
:::

### Validation contract

Structural validation contract for `variable_select_sr`, exported by the declarative validation framework (`benchmarks/validation/registry/`) from `benchmarks.parity_timing.registry`. Regenerated by `python -m benchmarks.validation.export_registry --write`.
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">1.05 ms</td><td class="ms">8.36 ms</td><td class="ms">41.3 ms</td><td class="ms ms-best">82.5 ms<span class="medal" title="fastest">🏆</span></td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.blas+omp</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">1.15 ms</td><td class="ms ms-best">8.36 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">41.3 ms</td><td class="ms">82.7 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.omp</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">1.04 ms</td><td class="ms">8.44 ms</td><td class="ms">43.0 ms</td><td class="ms">83.4 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.cpp.ref</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">1.08 ms</td><td class="ms">8.37 ms</td><td class="ms">41.7 ms</td><td class="ms">83.5 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.python</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms ms-best">1.03 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">8.39 ms</td><td class="ms ms-best">41.1 ms<span class="medal" title="fastest">🏆</span></td><td class="ms">83.6 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.sklearn</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">1.33 ms</td><td class="ms">8.66 ms</td><td class="ms">42.2 ms</td><td class="ms">83.6 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.R</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">2.87 ms</td><td class="ms">43.4 ms</td><td class="ms">462.8 ms</td><td class="ms">593.2 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.formula</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">3.82 ms</td><td class="ms">59.9 ms</td><td class="ms">587.1 ms</td><td class="ms">538.8 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.mdatools</code></td><td class="parity parity-divergence parity-drift">—</td><td class="ms">4.08 ms</td><td class="ms">61.9 ms</td><td class="ms">643.9 ms</td><td class="ms">535.0 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.R.pls</code></td><td class="parity parity-divergence parity-drift">—</td><td class="ms">4.06 ms</td><td class="ms">58.7 ms</td><td class="ms">577.1 ms</td><td class="ms">531.5 ms</td></tr>
</tbody>
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">1.65 ms</td><td class="ms">13.3 ms</td><td class="ms">66.9 ms</td><td class="ms">133.0 ms</td></tr>
<tr class="bk-row"><td class="bk-name"><code>pls4all.matlab.classdef</code></td><td class="parity parity-divergence parity-divergent">1.18</td><td class="ms">1.97 ms</td><td class="ms">13.8 ms</td><td class="ms">67.2 ms</td><td class="ms">133.7 ms</td></tr>
</tbody>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): plsVarSel 0.10.0 — qualitative (rmse_rel ≤ 1e+00)">📐</span><code>ref.r_plsvarsel</code></td><td class="parity parity-divergence parity-ref-source">0</td><td class="ms">8.35 ms</td><td class="ms">65.0 ms</td><td class="ms">614.9 ms</td><td class="ms">555.1 ms</td></tr>
</tbody>
</table>
</div>
