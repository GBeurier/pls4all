...
p4a_variable_select_sr_fit(ctx, cfg, &x_view, &y_view, /* hyperparams */, &res);
...
```python
import pls4all
from pls4all._methods import variable_select_sr_fit
with pls4all.Context() as ctx, pls4all.Config() as cfg:
    res = variable_select_sr_fit(ctx, cfg, X, y, n_components=4)
...
```matlab
res  = pls4all.fit("variable_select_sr", X, y, "NumComponents", 4);
