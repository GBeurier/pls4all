...
mdl = SelectivityRatioSelector(top_k, n_components=2, solver='nipals', center_x=True, scale_x=True, tol=1e-06, max_iter=500)
mdl.fit(X, y)
...
<tr class="bk-row"><td class="bk-name"><code>pls4all.registry</code></td><td class="parity parity-drift">≈</td><td class="ms ms-best">1.38 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">182.7 ms<span class="medal" title="fastest">🏆</span></td><td class="ms ms-best">4.87 ms<span class="medal" title="fastest">🏆</span></td></tr>
...
<tr class="bk-row truth-source truth-source-qualitative"><td class="bk-name"><span class="truth-mark" title="Registry parity reference (r): plsVarSel 0.10.0 — qualitative (rmse_rel ≤ 1e+00)">📐</span><code>ref.r_plsvarsel</code></td><td class="parity parity-drift">≈</td><td class="ms">430.6 ms</td><td class="ms">288.9 ms</td><td class="ms">455.5 ms</td></tr>
