...
| 1.7.0 | 7-21 (parallel batch) | 252 | + 126 symbols across signal conversion, orthogonalisation, feature selection, resampling, splitters, filters, signal type / NIRS metrics, transfer metrics, FCK static transformer. |
