...
is implemented. The supported fitted-model path is now live for NIPALS and
SIMPLS PLS regression (PLS1 / PLS2): fit, predict, transform, fitted-array
accessors and binary import/export.
