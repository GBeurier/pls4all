...
_Generated: 2026-05-17 20:04:32 UTC_  
_CSV: `tmpjta40q1n.csv` (4440 cells)_
...
Column names follow the `owner.language[.variant]` convention — anything starting with `pls4all.` is us, everything else is an external library. Per-algorithm tables show **only the columns that actually implement that algorithm**: a backend without coverage is removed from the section's table entirely (rather than left as an empty cell). Full per-column description: see [Backend definitions](#backend-definitions) at the bottom of this page.
...
| samples × features | pls4all.R | pls4all.R.formula | pls4all.matlab.classdef |
|---|---|---|---|
...
| samples × features | pls4all.py | pls4all.py.sklearn | pls4all.R | pls4all.R.formula | R.pls | pls4all.matlab | pls4all.matlab.classdef |
|---|---|---|---|---|---|---|---|
...
_No successful backend for this algorithm — see CSV for failure reasons._
...
| samples × features | pls4all.py | pls4all.py.sklearn | pls4all.R | pls4all.R.formula | pls4all.matlab | pls4all.matlab.classdef |
|---|---|---|---|---|---|---|
...
| samples × features | pls4all.cpp | pls4all.py | pls4all.py.sklearn | pls4all.R | pls4all.R.formula | pls4all.matlab | pls4all.matlab.classdef |
|---|---|---|---|---|---|---|---|
...
| samples × features | pls4all.R | pls4all.R.formula |
|---|---|---|
...
| samples × features | pls4all.cpp | pls4all.py | pls4all.py.sklearn | python.sklearn | python.ikpls | pls4all.R | pls4all.R.formula | R.pls | R.mixomics | pls4all.matlab | pls4all.matlab.classdef | matlab.plsregress |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| samples × features | pls4all.cpp | pls4all.py | pls4all.R |
|---|---|---|---|
...
| samples × features | pls4all.py | pls4all.py.sklearn | python.sklearn | pls4all.R | pls4all.R.formula | pls4all.matlab | pls4all.matlab.classdef |
|---|---|---|---|---|---|---|---|
...
| samples × features | pls4all.cpp | pls4all.py | pls4all.py.sklearn | pls4all.R | pls4all.R.formula | R.mixomics | pls4all.matlab | pls4all.matlab.classdef |
|---|---|---|---|---|---|---|---|---|
...
| `pls4all.py` | Python | pls4all raw | `pls4all._methods.<algo>_fit(ctx, cfg, X, y, …)` — direct FFI binding |
| `pls4all.py.sklearn` | Python | pls4all idiomatic | `pls4all.sklearn.<Class>` — sklearn-style BaseEstimator with `.fit() / .predict()` |
| `python.sklearn` | Python | external | `sklearn.cross_decomposition.PLSRegression`, `sklearn.decomposition.PCA + LinearRegression / Ridge / GaussianProcessRegressor` (proxies) |
| `python.ikpls` | Python | external | `ikpls.numpy_ikpls.PLS` — Improved Kernel PLS (covers plain PLS only) |
...
| `R.pls` | R | external | CRAN `pls` package — `pls::plsr / pls::cppls / pls::pcr` |
| `R.ropls` | R | external | Bioconductor `ropls` — `ropls::opls` (covers OPLS only) |
| `R.mixomics` | R | external | Bioconductor `mixOmics` — `pls / spls / plsda / splsda` |
...
| `matlab.plsregress` | MATLAB/Octave | external | Octave statistics `plsregress` (SIMPLS, plain PLS only) |
...
| `pls4all.py` | `language=Python 3.13.11`; `blas=libscipy_openblas 0.3.30 blas=1`; `pls4all=0.97.0`; `numpy=2.3.5` |
| `pls4all.py.sklearn` | `language=Python 3.13.11`; `blas=libscipy_openblas 0.3.30 blas=1; libscipy_openblas 0.3.30 blas=1; libgomp ? openmp=1`; `pls4all=0.97.0`; `numpy=2.3.5` |
| `python.sklearn` | `language=Python 3.13.11`; `blas=libscipy_openblas 0.3.30 blas=1; libscipy_openblas 0.3.30 blas=1; libgomp ? openmp=1`; `sklearn=1.8.0`; `numpy=2.3.5` |
| `python.ikpls` | `language=Python 3.13.11`; `blas=libscipy_openblas 0.3.30 blas=1; libscipy_openblas 0.3.30 blas=1; libgomp ? openmp=1`; `ikpls=4.0.1.post1`; `numpy=2.3.5` |
...
| `R.pls` | `language=R 4.3.3`; `pls=2.8.5` |
| `R.ropls` | `language=R 4.3.3`; `ropls=1.34.0` |
| `R.mixomics` | `language=R 4.3.3`; `mixOmics=6.26.0` |
...
| `matlab.plsregress` | `language=Octave 10.3.0`; `statistics=Octave statistics pkg (plsregress)`; `blas=linked-BLAS` |
